...
type
  TFrmAtualizaWigCred = class(TForm)
    Label1: TLabel;
...
var
  FrmAtualizaWigCred: TFrmAtualizaWigCred;
...
procedure TFrmAtualizaWigCred.DisposeStrList(const StrList: TStrings);
var
  I: Integer;
begin
...
function TFrmAtualizaWigCred.GetRegDir: String;
var
  FReg: TRegIniFile;
  F: TextFile;
begin
...
procedure TFrmAtualizaWigCred.GetExtNames(const ExtDir, ExtName: String; const StrLst: TStrings);
var
  SR: TSearchRec;
  InfoFile: TInfoFile;
begin
...
procedure TFrmAtualizaWigCred.GetExeNames(const ExeDir: String; const StrLst: TStrings);
begin
  StrLst.BeginUpdate;
  try
    GetExtNames(ExeDir, WIGCRED_EXE, StrLst);
  finally
    StrLst.EndUpdate;
  end;
end;

procedure TFrmAtualizaWigCred.GetININames(const ExeDir: String;
...
procedure TFrmAtualizaWigCred.UpdateFile(FileName: String);
var
  OldName: String;
  SRLocal: TSearchRec;
  Ext: String;
...
procedure TFrmAtualizaWigCred.CompareCopyFiles(const SourceDir, DestDir: String; const FStrList: TStrings; const FOverWrite : Boolean = True);
var
  x: Integer;
  SRLocal: TSearchRec;
  L,R: TDateTime;
...
procedure TFrmAtualizaWigCred.Atualiza;
var
  Indice : LongInt;
  StrList: TStrings;
  LocalP,
...
procedure TFrmAtualizaWigCred.TimerAtualizaTimer(Sender: TObject);
begin
...
function TFrmAtualizaWigCred.flEhAcessoLocal: Boolean;
Var
  lsPastaAtual : String;
begin
