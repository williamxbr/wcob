object Dadosxx: TDadosxx
  ...
  object MT_PENDENCIAS_CREDOR: TkbmMemTable
    Active = True
    ...
    Left = 590
    Top = 16
    object MT_PENDENCIAS_CREDORCREDOR: TIntegerField
      FieldName = 'CREDOR'
    end
    object MT_PENDENCIAS_CREDORNOME_CREDOR: TStringField
      FieldName = 'NOME_CREDOR'
    end
    object MT_PENDENCIAS_CREDORDEVEDOR: TIntegerField
      FieldName = 'DEVEDOR'
    end
    object MT_PENDENCIAS_CREDORNOME_DEVEDOR: TStringField
      FieldName = 'NOME_DEVEDOR'
    end
    object MT_PENDENCIAS_CREDORDATA_DIVIDA: TDateField
      FieldName = 'DATA_DIVIDA'
    end
    object MT_PENDENCIAS_CREDORVENCIMENTO: TDateField
      FieldName = 'VENCIMENTO'
    end
    object MT_PENDENCIAS_CREDORVALOR: TFloatField
      FieldName = 'VALOR'
    end
  end
