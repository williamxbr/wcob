object frmTipoDocumento: TfrmTipoDocumento
  Left = 575
  Top = 204
  BorderStyle = bsSingle
  Caption = 'frmTipoDocumento'
  ClientHeight = 315
  ClientWidth = 343
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object gbRodape: TGroupBox
      ...
      object DBNavTipoDocumento: TDBNavigator
        Left = 2
        Top = 10
        Width = 222
        Height = 25
  ...
  object pnTela: TPanel
    ...
    object DBTIPO_DOCUMENTO: TDBEdit
      Left = 5
      Top = 20
      Width = 73
      Height = 21
    ...
    object DBSIGLA_DOCUMENTO: TDBEdit
      Left = 101
      Top = 20
      Width = 73
      Height = 21
      Ctl3D = True
      DataField = 'SIGLA_DOCUMENTO'
      DataSource = dsTipoDocumento
      ParentCtl3D = False
      TabOrder = 2
    end
    object cxGrid1: TcxGrid
      ...
      object cxGrid1DBTableView1: TcxGridDBTableView
        DataController.DataSource = dsTipoDocumento
        ...
        object cxGrid1DBTableView1TIPO_DOCUMENTO1: TcxGridDBColumn
          Caption = 'Tipo'
        ...
        object cxGrid1DBTableView1SIGLA_DOCUMENTO1: TcxGridDBColumn
          Caption = 'Sigla'
          DataBinding.FieldName = 'SIGLA_DOCUMENTO'
          PropertiesClassName = 'TcxTextEditProperties'
          Properties.Alignment.Horz = taLeftJustify
          Properties.ReadOnly = True
